...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(tabs)/gallery` | `/gallery` | `/(tabs)/` | `/(tabs)` | `/(tabs)/settings` | `/settings`;
  // prettier-ignore
  type DynamicRoutes<T extends string> = `/editor/${SingleRoutePart<T>}`;
  // prettier-ignore
  type DynamicRouteTemplate = `/editor/[id]`;
